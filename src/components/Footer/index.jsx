    ...
    <div className="bg-black text-white px-48 py-10  h-80  items-center flex flex-col gap-10 w-full">
      ...
      <div className="flex w-full justify-between">
        <div className="text-2xl select-none">
          <Link
            href={"/"}
            className="font-[--font-family-sans-serif]  text-lg text-white flex items-center gap-2 hover:underline underline-offset-3"
        ...
        <div className="flex  flex-col gap-[10px] text-gray-200">
          <Link
            href={"/"}
            className="text-sm text-gray-300 text-inherit    hover:translate-x-2 duration-200 transition-all delay-75"
          >
            Youtube Downloader
          </Link>{" "}
          <Link
